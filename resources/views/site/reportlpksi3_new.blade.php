...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Peta Lintasan Pejalan Kaki Searas Berlampu Isyarat</h2>
        <ol class="breadcrumb">
            <li>
                Peta Lintasan Pejalan Kaki Searas Berlampu Isyarat
            </li>
        </ol>
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Peta Kawasan Lokasi Lintasan Pejalan Kaki Searas Berlampu Isyarat <?php if(Auth::user()->jkrnegeri() || Auth::user()->jkrdaerah()){ ?>untuk Negeri {{$negeriname}} <?php } ?>bagi Tahun {{$list_tahun[$filter[2]]}}</h5>
...
//      zoom:9,
    ...
    google.maps.event.addListener(mymap.map, "idle", didle);
      ...
      $.each( blackspot, function( index, value ){
        ...
        icon = {
                url: "{{ URL::asset('rams/images/spot/lintasan.png') }}",
