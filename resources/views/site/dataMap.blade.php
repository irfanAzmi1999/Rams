                    ...
                    <div class="file-manager">
                        ...
                        <div class="scroll_content">
                            <ul class="folder-list m-b-md" style="padding: 0">
                                <li>
                                    <a><i class="fa fa-file"></i> No Laporan
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                        ...
                                        <input type="hidden" name="exstatus_la" value="{{$exstatus_la}}">
                            ...
                            <div class="scroll_content">
                                <ul class="folder-list m-b-md" style="padding: 0">
                                    <li>
                                        <a>
                                            <i class="fa fa-map-marker"></i> No. Laporan
                                            <span class="label label-warning pull-right" id="d_no_laporan">-</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a>
                                    ...
                                    <li>
                                        <a>
                                            <i class="fa fa-stethoscope"></i> Jenis Kemalangan
                                            <span class="label label-warning pull-right" id="d_jenis_kemalangan"></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a>
                                            <i class="fa fa-calendar"></i> Tarikh Kejadian
                                            <span class="label label-warning pull-right" id="d_tarikh_kejadian">-</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a>
                                    ...
                                    <li>
                                        <a>
                                            <i class="fa fa-cogs"></i> Jenis Permukaan
                                            <span class="label label-warning pull-right" id="d_jenis_permukaan"></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a>
                                            <i class="fa fa-road"></i> Keadaan Jalan
                                            <span class="label label-warning pull-right" id="d_keadaan_jalan"></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a>
                                            <i class="fa fa-road"></i> Kualiti Permukaan
                                            <span class="label label-warning pull-right" id="d_kualiti_permukaan"></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a>
                                            <i class="fa fa-arrows-alt"></i> Sistem Lalulintas
                                            <span class="label label-warning pull-right" id="d_sistem_laluan"></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a>
                                            <i class="fa fa-sun-o"></i> Cuaca
                                            <span class="label label-warning pull-right" id="d_cuaca"></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a>
                                            <i class="fa fa-car"></i> Jenis Pelanggaran Pertama
                                            <span class="label label-warning pull-right" id="d_jenis_langgar_pertama"></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a>
                                            <i class="fa fa-road"></i> Bentuk Jalan
                                            <span class="label label-warning pull-right" id="d_bentuk_jalan"></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a>
                                            <i class="fa fa-bars"></i> Jenis Garisan
                                            <span class="label label-warning pull-right" id="d_jenis_garis"></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a>
                                            <i class="fa fa-road"></i> Jenis Permukaan Jalan
                                            <span class="label label-warning pull-right" id="d_muka_jalan"></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a>
                                            <i class="fa fa-road"></i> Sebab Utama Kecacatan Jalan
                                            <span class="label label-warning pull-right" id="d_sebab_cacat_jalan"></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a>
                                            <i class="fa fa-sun-o"></i> Cahaya
                                            <span class="label label-warning pull-right" id="d_cahaya"></span>
                                        </a>
                                    </li>
<!--
                                    <li>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group m-b">
                                    ...
                                    {!! html()->text('no_laporan', empty($exno_laporan) ? '' : $exno_laporan)
                                    ->class('form-control')
...
$(document).on('click','.kenderaan-data',function() {
    ...
    var table = $('.table-list-fdata').DataTable({
        ...
        ajax:  {
            url: 'getDataMap',
            data: function (d) {
                d.no_laporan = $('input[name=no_laporan]').val() ? $('input[name=no_laporan]').val() : '';
                ...
                d.jenispermukaan = $('select[name=jenispermukaan]').val() ? $('select[name=jenispermukaan]').val() : '';
                d.keadaanjalan = $('select[name=keadaanjalan]').val() ? $('select[name=keadaanjalan]').val() : '';
                d.kualitipermukaan = $('select[name=kualitipermukaan]').val() ? $('select[name=kualitipermukaan]').val() : '';
                d.sistemlaluan = $('select[name=sistemlaluan]').val() ? $('select[name=sistemlaluan]').val() : '';
                d.cuaca = $('select[name=cuaca]').val() ? $('select[name=cuaca]').val() : '';
                d.jenislanggarpertama = $('select[name=jenislanggarpertama]').val() ? $('select[name=jenislanggarpertama]').val() : '';
                d.bentukjalan = $('select[name=bentukjalan]').val() ? $('select[name=bentukjalan]').val() : '';
                d.jenisgaris = $('select[name=jenisgaris]').val() ? $('select[name=jenisgaris]').val() : '';
                d.mukajalan = $('select[name=mukajalan]').val() ? $('select[name=mukajalan]').val() : '';
                d.sebabcacatjalan = $('select[select=sebabcacatjalan]').val() ? $('select[name=sebabcacatjalan]').val() : '';
                d.cahaya = $('select[name=cahaya]').val() ? $('select[name=cahaya]').val() : '';
        ...
        columns: [
            ...
            {data: 'jenis_kemalangan', name: 'jenis_kemalangans.name'},
            {data: 'status_la'},
