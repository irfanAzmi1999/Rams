        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Peta Kawasan Kerap Kemalangan (Black Spot) <?php if(Auth::user()->jkrnegeri() || Auth::user()->jkrdaerah()){ ?>untuk Negeri {{$negeriname}} <?php } ?>bagi Tahun {{$list_tahun[$filter[2]]}}</h5>
...
<div class="modal inmodal" id="modal-filter-bdata">
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Tutup</span></button>
                <h4 class="modal-title">Tapisan Data Blackspot</h4>
            </div>
