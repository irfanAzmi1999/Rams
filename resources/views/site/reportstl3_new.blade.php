...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Peta Smart Traffic Light</h2>
        <ol class="breadcrumb">
            <li>
                Peta Smart Traffic Light
            </li>
        </ol>
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Peta Kawasan Lokasi Smart Traffic Light <?php if(Auth::user()->jkrnegeri() || Auth::user()->jkrdaerah()){ ?>untuk Negeri {{$negeriname}} <?php } ?>bagi Tahun {{$list_tahun[$filter[2]]}}</h5>
...
<div class="modal inmodal" id="modal-filter-bdata">
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Tutup</span></button>
                <h4 class="modal-title">Tapisan Data Smart Traffic Light</h4>
            </div>
