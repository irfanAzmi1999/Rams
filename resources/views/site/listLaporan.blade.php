...
<script src="{{ URL::asset('inspinia/js/plugins/chosen/chosen.jquery.js') }}"></script>
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Senarai Laporan Kawasan Kerap Kemalangan</h2>
            <ol class="breadcrumb">
                <li>
                    Senarai Laporan Kawasan Kerap Kemalangan
                </li>
                <li>
                    Senarai Laporan
                </li>
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Peta Kawasan Kerap Kemalangan (Black Spot) Yang Telah Dirawat @if(!empty($filter[0])) bagi Tahun {{ $filter[0] }} @endif</h5>
