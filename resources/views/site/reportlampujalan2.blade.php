...
function getOverlayImage(bounds,map) {
    ...
    var smallmap = function(lat, lng, mapid, blackid, tahun) {
        ...
        google.maps.event.addListener(mymap2[mapid].map, "idle", didle);
            ...
            icon = {
                    url: "{{ URL::asset('rams/images/spot/lampujalan.png') }}",
...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Kawasan Lokasi Lampu Jalan</h2>
        <ol class="breadcrumb">
            <li>
                Lokasi Lampu Jalan
            </li>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Laporan Kawasan Lokasi Lampu Jalan bagi Tahun {{$tahun}}</h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table style="border-collapse: collapse;">
                                            <tr>
                                                <td class="p-xs"><span class="badge label-black text-14">Maut</span></td>
                                                <td class="text-black font-bold text-right text-14">{{ $b['bil_maut'] }}</td>
                                            </tr>
                                            <tr>
                                                <td class="p-xs"><span class="badge badge-danger text-14">Parah</span></td>
                                                <td class="text-black font-bold text-right text-14">{{ $b['bil_parah'] }}</td>
                                            </tr>
                                            <tr>
                                                <td class="p-xs"><span class="badge badge-primary text-14">Ringan</span></td>
                                                <td class="text-black font-bold text-right text-14">{{ $b['bil_ringan'] }}</td>
                                            </tr>
                                            <tr>
                                                <td class="p-xs"><span class="badge badge-success text-14">Rosak</span></td>
                                                <td class="text-black font-bold text-right text-14">{{ $b['bil_rosak'] }}</td>
                                            </tr>
                                            <tr>
                                                <td class="p-xs"><span class="badge badge text-14">Tidak Diketahui</span></td>
                                                <td class="text-black font-bold text-right text-14">{{ $b['bil_tidak_diketahui'] }}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-black font-bold p-xs text-14">Jumlah</td>
                                                <td class="text-black font-bold text-right text-14">{{ $b['pemberat'] }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td><?php echo $tahun; ?></td>
                                    <td><?php echo $b['nama_negeri']; ?></td>
                                    <td>&nbsp;</td>
                                    <td>{{ $b['no_laluan'] }}</td>
                                    <td>{{ $b['nombor_seksyen'] }}</td>
                                    <td>&nbsp;</td>
...
<div class="modal inmodal" id="modal-filter-bdata">
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Tutup</span></button>
                <h4 class="modal-title">Tapisan Data Lampu Jalan</h4>
            </div>
