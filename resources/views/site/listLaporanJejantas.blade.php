...
<script src="{{ URL::asset('inspinia/js/plugins/chosen/chosen.jquery.js') }}"></script>
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Senarai Laporan Kawasan Lokasi Jejantas</h2>
            <ol class="breadcrumb">
                <li>
                    Senarai Laporan Kawasan Lokasi Jejantas
                </li>
                <li>
                    Senarai Laporan
                </li>
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Peta Kawasan Lokasi Jejantas (Prestasi) @if(!empty($filter[0])) bagi Tahun {{ $filter[0] }} @endif</h5>
                ...
                <form id="form-tambah-laporan" method="POST" action="{{ URL('/daftarLaporan') }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label><strong>Maklumat Kawasan Lokasi Jejantas</strong></label>
                                    <div class="row">
                                        <div class="col-lg-12">
