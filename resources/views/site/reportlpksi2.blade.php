...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Kawasan Lokasi Lintasan Pejalan Kaki Searas Berlampu Isyarat</h2>
        <ol class="breadcrumb">
            <li>
                Lokasi Lintasan Pejalan Kaki Searas Berlampu Isyarat
            </li>
        </ol>
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Laporan Kawasan Lokasi Lintasan Pejalan Kaki Searas Berlampu Isyarat bagi Tahun {{$tahun}}</h5>
