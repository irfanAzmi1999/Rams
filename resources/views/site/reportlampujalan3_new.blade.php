        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Peta Kawasan Lokasi Lampu Jalan <?php if(Auth::user()->jkrnegeri() || Auth::user()->jkrdaerah()){ ?>untuk Negeri {{$negeriname}} <?php } ?>bagi Tahun {{$list_tahun[$filter[2]]}}</h5>
