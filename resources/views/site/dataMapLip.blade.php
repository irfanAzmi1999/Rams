...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Data Lampu Isyarat Di Persimpangan</h2>
        <ol class="breadcrumb">
            <li>
                Data Lampu Isyarat Di Persimpangan
            </li>
            <li>
                Paparan Data
            </li>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Senarai Data Lampu Isyarat Di Persimpangan</h5>
            ...
            <form id="form-filter-fdata" method="POST" action="{{URL('/filterdataMap')}}">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><strong>Tarikh Pembangunan (Mula)</strong></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><strong>Tarikh Pembangunan (Akhir)</strong></label>
                                <div class="input-group date">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
