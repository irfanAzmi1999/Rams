                                    ...
                                    <div class="col-md-12">
                                        <div class="panel panel-success">
                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        Untuk jenis lintasan pejalan kaki searas berlampu isyarat, Nilai PV di antara 50,000 hingga 100,000
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="ibox">
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-sm-4 col-form-label text-center" style="border: 1px solid black;">50,000 hingga 100,000</label>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="text-right">
                                            <a href="{{route('analisisLpksi')}}" class="btn btn-w-m btn-success">Hantar Permohonan</a>
                                        </div>
                                    </div>
                                </div>
                             </div>  
