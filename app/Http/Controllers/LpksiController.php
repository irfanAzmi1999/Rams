...
class LpksiController extends Controller
{
    protected $gmap;
    ...
    public function generateLpksiData()
    {
...
//                $dbblackspot -> jenis_langgar_pertama_id='0';
    ...
    public function dataLpksi2($input = []) {
    ...
    public function dataReport(Request $request) {
        ...
        $blackspot = [];
        //DB::enableQueryLog();
        $blackspot = self::dataLpksi2($input);
        //dd(DB::getQueryLog());
        ...
        return view('site.reportlpksi2', compact('test', 'map', 'negeri', 'daerah', 'nolaluan'), [
            'filter' => $filter,
            'test' => $test,
            'pagination' => $paginate,
            'tahun' => $getyear,
    ...
    // EXCEL FILE DOWNLOAD
    public function lpksiexportexcel(Request $request) {
        if (!empty($request->all())) {
            $input = $request->all();
        } else {
            $input = [
        ...
        return view('site/lpksiexcelaccident', compact('blackspot'));
    }

    // CSV FILE DOWNLOAD
    public function lpksiexportcsv(Request $request) {
        if (!empty($request->all())) {
            $input = $request->all();
        } else {
            $input = [
        ...
        $blackspot = self::dataLpksi2($input);
        return view('site/lpksicsvaccident', compact('blackspot'));
    }

    // JSON FILE DOWNLOAD
    public function lpksiexportjson(Request $request) {
        if (!empty($request->all())) {
            $input = $request->all();
        } else {
            $input = [
        ...
        return view('site/lpksijsonaccident', [
            'blackspot' => $blackspot
        ]);
    }

    // PDF FILE DOWNLOAD
    public function lpksiexportpdf(Request $request) {
        if (!empty($request->all())) {
            $input = $request->all();
        } else {
            $input = [
        ...
        $pdf = \PDF::loadView('site/lpksipdfaccident', compact('blackspot'));
    ...
    public function dataLpksi(Request $request) {
        ...
        return view('site.reportlpksi3_new', compact('map', 'blackspot', 'negeri', 'daerah', 'nolaluan'), [
            'filter' => $filter,
            'zoomnegeri' => $zoomnegeri,
            'keluasan' => $keluasan,
            'list_tahun' => $list_tahun,
    ...
    public function dataMapLpksi(Request $request) {
        if (!empty($request->all())) {
            $input = $request->all();
        } else {
	...
	public function getDataMapLpksi(
        Request $request,
    ...
    public function analisisLpksi() {
        return view('site.waranLpksi');
    }

    public function waranLpksi()
    {
	return view('site.waranLpksiBorang');
    }
