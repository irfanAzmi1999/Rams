...
class LipController extends Controller
{
    ...
    public function generateLipData()
    {
...
//                $dbblackspot -> jenis_langgar_pertama_id='0';
    ...
    public function dataLip2($input = []) {
    ...
    public function dataReport(Request $request) {
        ...
        return view('site.reportlip2', compact('test', 'map', 'negeri', 'daerah', 'nolaluan'), [
            'filter' => $filter,
            'test' => $test,
            'pagination' => $paginate,
            'tahun' => $getyear,
    ...
    // EXCEL FILE DOWNLOAD
    public function lipexportexcel(Request $request) {
        if (!empty($request->all())) {
            $input = $request->all();
        } else {
            $input = [
        ...
        return view('site/lipexcelaccident', compact('blackspot'));
    }

    // CSV FILE DOWNLOAD
    public function lipexportcsv(Request $request) {
        if (!empty($request->all())) {
            $input = $request->all();
        } else {
            $input = [
        ...
        $blackspot = self::dataLip2($input);
        return view('site/lipcsvaccident', compact('blackspot'));
    }

    // JSON FILE DOWNLOAD
    public function lipexportjson(Request $request) {
        if (!empty($request->all())) {
            $input = $request->all();
        } else {
            $input = [
        ...
        return view('site/lipjsonaccident', [
            'blackspot' => $blackspot
        ]);
    }

    // PDF FILE DOWNLOAD
    public function lipexportpdf(Request $request) {
        if (!empty($request->all())) {
            $input = $request->all();
        } else {
            $input = [
        ...
        $pdf = \PDF::loadView('site/lippdfaccident', compact('blackspot'));
    ...
    public function dataLip(Request $request) {
        ...
        return view('site.reportlip3_new', compact('map', 'blackspot', 'negeri', 'daerah', 'nolaluan'), [
            'filter' => $filter,
            'zoomnegeri' => $zoomnegeri,
            'keluasan' => $keluasan,
            'list_tahun' => $list_tahun,
    ...
    public function dataMapLip(Request $request) {
        if (!empty($request->all())) {
            $input = $request->all();
        } else {
    ...
    public function analisisLip() {
        return view('site.waranLip');
    }

    public function waranLip()
    {
	return view('site.waranLipBorang');
    }
