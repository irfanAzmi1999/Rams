...
class JejantasController extends Controller {
    ...
    public function generateJejantasData() {
...
//                $dbblackspot -> jenis_langgar_pertama_id='0';
    ...
    public function dataJejantas2($input = []) {
                    ...
                    if ($blackspot_condition) {
                        ...
                        if ($s['bid'] != $q) {
                            foreach ($blackspot2 as $spot_blackspot2) {
                                ...
                                if ($distance < ($keluasan / 1000) && $s['negeri'] === $spot_blackspot2['negeri'] && $s['laluan'] === $spot_blackspot2['laluan']) {
                                    $near_spot = true;
                                }
                            }
                            if (!$near_spot) {
    ...
    public function dataReport(Request $request) {
        ...
        $blackspot = [];
        //DB::enableQueryLog();
        $blackspot = self::dataJejantas2($input);
        //dd(DB::getQueryLog());
        ...
        return view('site.reportjejantas2', compact('test', 'map', 'negeri', 'daerah', 'nolaluan'), [
            'filter' => $filter,
            'test' => $test,
            'pagination' => $paginate,
            'tahun' => $getyear,
    ...
    // EXCEL FILE DOWNLOAD
    public function jejantasexportexcel(Request $request) {
        if (!empty($request->all())) {
            $input = $request->all();
        } else {
            $input = [
        ...
        return view('site/jejantasexcelaccident', compact('blackspot'));
    }

    // CSV FILE DOWNLOAD
    public function jejantasexportcsv(Request $request) {
        if (!empty($request->all())) {
            $input = $request->all();
        } else {
            $input = [
        ...
        $blackspot = self::dataJejantas2($input);
        return view('site/jejantascsvaccident', compact('blackspot'));
    }

    // JSON FILE DOWNLOAD
    public function jejantasexportjson(Request $request) {
        if (!empty($request->all())) {
            $input = $request->all();
        } else {
            $input = [
        ...
        return view('site/jejantasjsonaccident', [
            'blackspot' => $blackspot
        ]);
    }

    // PDF FILE DOWNLOAD
    public function jejantasexportpdf(Request $request) {
        if (!empty($request->all())) {
            $input = $request->all();
        } else {
            $input = [
        ...
        $pdf = \PDF::loadView('site/jejantaspdfaccident', compact('blackspot'));
    ...
    public function dataJejantas(Request $request) {
        ...
        return view('site.reportjejantas3_new', compact('map', 'blackspot', 'negeri', 'daerah', 'nolaluan'), [
            'filter' => $filter,
            'zoomnegeri' => $zoomnegeri,
            'keluasan' => $keluasan,
            'list_tahun' => $list_tahun,
    ...
    public function dataMapJejantas(Request $request) {
        if (!empty($request->all())) {
            $input = $request->all();
        } else {
    ...
    public function getDataMapJejantas(
        Request $request,
    ...
    public function analisisJejantas() {
        return view('site.waranJejantas');
    }

    public function waranJejantas()
    {
	return view('site.waranJejantasBorang');
    }
}
